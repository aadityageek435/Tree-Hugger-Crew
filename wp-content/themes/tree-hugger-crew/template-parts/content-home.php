...
<section class="sec-about-us">
    <div class="sec-wp">
        <div class="about-path">
            <img src="<?php echo home_url(); ?>/wp-content/themes/tree-hugger-crew/assets/images/about-path.svg" alt="about-path" width="1675" height="630">
        </div>
        <div class="container">
            <div class="row">
                <?php  
    ...
    <div class="sec-wp">
        <div class="container">
            <div class="ig-title">
                ...
                <ul>
                    <li><a href="javascript:void(0);">Follow Us</a></li>
